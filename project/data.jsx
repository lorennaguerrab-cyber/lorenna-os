...
const NAV = [
  ...
  { href: '/ideias',       icon: 'bulb',     label: 'Acervo de Conteúdo'},
  { href: '/tarefas',      icon: 'check',    label: 'Tarefas'           },
  { href: '/conteudo',     icon: 'doc',      label: 'Conteúdo'          },
...
const DEMO_TASKS = [
  ...
  {
    id: 't2', titulo: 'Entregar posts semana Pratique Academia',
    status: 'em_progresso', prioridade: 'urgente', energia: ['operacional'],
    categoria: 'cliente', cliente: 'Pratique Academia', recorrente: true,
    micro: [
      { id: 'm4', desc: 'Criar 3 artes no Canva',           done: true,  min: 20 },
      { id: 'm5', desc: 'Escrever 3 legendas',              done: false, min: 15 },
      { id: 'm6', desc: 'Agendar no Meta Business Suite',   done: false, min: 10 },
    ],
  },
  {
    id: 't3', titulo: 'Escrever newsletter semanal',
    status: 'pendente', prioridade: 'alta', energia: ['criativa', 'foco'],
    categoria: 'conteudo', recorrente: true,
    micro: [
      { id: 'm7',  desc: 'Definir tema da semana',         done: false, min: 5 },
      { id: 'm8',  desc: 'Escrever rascunho com IA',       done: false, min: 20 },
      { id: 'm9',  desc: 'Revisar e personalizar',         done: false, min: 15 },
      { id: 'm10', desc: 'Programar envio no Mailchimp',   done: false, min: 5 },
    ],
  },
  {
    id: 't4', titulo: 'Responder e-mails pendentes',
  ...
  },
  {
    ...
    categoria: 'conteudo', recorrente: false,
    micro: [
      { id: 'm11', desc: 'Escolher tema com alto potencial SEO', done: false, min: 10 },
      { id: 'm12', desc: 'Estruturar o artigo',                  done: false, min: 10 },
      { id: 'm13', desc: 'Escrever com apoio de IA',             done: false, min: 30 },
...
const DEMO_IDEAS = [
  { id: 'i1', titulo: '"Domingo é o único dia em que tenho 47 ideias criativas e zero energia pra executar."',
    desc: 'Frase perfeita pra reel de bastidores. Alta ressonância com criadores.',
  ...
  { id: 'i4', titulo: '5 ferramentas de IA que uso todo dia (sem complicar)',
    desc: 'Claude, Midjourney, Whisper, Canva AI, ChatGPT. Como uso cada um na prática.',
  ...
  { id: 'i5', titulo: 'Como me organizo sendo mãe, criadora e dona de agência',
    desc: 'O método real — sem glamour, sem mentira.',
  ...
  { id: 'i6', titulo: 'Carrossel: anatomia de um livro infantil que vende',
    desc: 'Capa, paleta, virada de página, tipografia. Estrutura visual.',
...
const DEMO_CONTENT = [
  { id: 'c1', titulo: 'Como organizo minha semana sendo mãe e criadora', tipo: 'blog',
    ...
    data: 'Há 7 dias' },
  { id: 'c2', titulo: 'Reel: Por que sua marca precisa de uma voz única', tipo: 'reel',
    plataformas: ['instagram', 'tiktok'], status: 'editando', categoria: 'branding',
    data: 'Em 2 dias' },
  { id: 'c3', titulo: 'Newsletter: 5 ferramentas de IA que mudaram minha produtividade', tipo: 'newsletter',
  ...
  { id: 'c4', titulo: 'Análise de marca: Duolingo e o poder do caos controlado', tipo: 'youtube',
    plataformas: ['youtube', 'blog'], status: 'ideia', categoria: 'analise_marcas', data: '' },
  { id: 'c5', titulo: 'Série Mulheres Incríveis — Ep. 01: Luisa Sonza como marca', tipo: 'youtube',
    plataformas: ['youtube'], status: 'rascunho', categoria: 'mulheres_incriveis',
    data: 'Em 5 dias' },
  { id: 'c6', titulo: 'Reel bastidores: minha rotina de criação de conteúdo', tipo: 'reel',
    plataformas: ['instagram'], status: 'agendado', categoria: 'bastidores',
    data: 'Em 1 dia' },
  { id: 'c7', titulo: 'Carrossel: 7 erros de branding que destroem marcas pequenas', tipo: 'carrossel',
  ...
  { id: 'c8', titulo: 'Anatomia visual de "O Pequeno Príncipe"', tipo: 'carrossel',
    plataformas: ['instagram', 'pinterest'], status: 'ideia', categoria: 'livros_infantis', data: '' },
];
...
/* ── CRM demo ── */
const DEMO_CRM = [
  { id: 'crm1', nome: 'Reserva',        tipo: 'marca',      status: 'potencial',  plataforma: 'instagram',
    proposta: 'UGC de moda feminina — coleção inverno 2026', valor: 800, proxima: 'Enviar proposta personalizada',
    followup: 'em 2 dias', notas: 'Marca com estética alinhada. Alta chance de fechar.' },
  { id: 'crm2', nome: 'Mari Gonzalez',  tipo: 'influencer', status: 'em_contato', plataforma: 'instagram',
  ...
  { id: 'crm3', nome: 'iFood',          tipo: 'marca',      status: 'negociando', plataforma: 'instagram',
  ...
  { id: 'crm4', nome: 'Paolla Gisele',  tipo: 'collab',     status: 'fechado',    plataforma: 'instagram',
    proposta: 'UGC planejamento — collab conjunto', valor: 600, proxima: 'Entregar conteúdo até dia 20',
    followup: '',          notas: 'Collab confirmado. Conteúdo em produção.' },
  { id: 'crm5', nome: 'Granado',        tipo: 'marca',      status: 'potencial',  plataforma: 'instagram',
    proposta: 'UGC linha bebê — relato de mãe real',  proxima: 'Escrever primeiro contato',
    followup: 'em 4 dias',  notas: 'Estética nostálgica casa demais com Papel da Lola.' },
  { id: 'crm6', nome: 'Tatá Werneck',   tipo: 'collab',     status: 'em_contato', plataforma: 'instagram',
    proposta: 'Quadro "Mulheres que viraram marca"',  proxima: 'Aguardando resposta — follow-up sexta',
    followup: 'em 3 dias',  notas: 'Demonstrou interesse em DM. Pessoa do agente respondeu pedindo proposta.' },
];
